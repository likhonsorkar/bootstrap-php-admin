...
?>
<h2 class="text-center h1 mb-2">Result For "<?php echo $catname ?>"</h2>
                <?php 
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 position-relative">
                                    ...
                                    <div class="post-overlay">
                                        ...
                                        ?>
                                        <a href="category.php?slug=<?php echo $catdata['slug'] ?>&catname=<?php echo $catdata['category_name']; ?>" class="badge bg-success mb-2"><?php echo $catdata['category_name']; ?></a>
                                    </div>
                                </div>
